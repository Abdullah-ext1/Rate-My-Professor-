    ...
    <div className="fixed top-0 left-0 right-0 bg-bg px-4 py-2.5 flex items-center justify-between flex-shrink-0 border-b border-border z-30">
      ...
      <div className="flex items-center gap-3">
        ...
        {user?.currentStreak > 0 && (
          <div className="px-2 py-1 h-8 rounded-lg flex items-center gap-1 cursor-default">
            <span className="text-sm">🔥</span>
            <span className="text-[10px] font-bold text-orange-400">{user.currentStreak}</span>
          </div>
        )}
        <div
